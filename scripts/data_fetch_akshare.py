...
from stock_management.data.providers.akshare_provider import AkshareKlineProvider  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Fetch minute bars via AkShare and cache into local SQLite store.")
