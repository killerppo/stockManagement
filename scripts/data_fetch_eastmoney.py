...
from stock_management.data.providers.eastmoney_provider import EastmoneyKlineProvider  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Fetch 1m bars from Eastmoney and cache into local SQLite store.")
